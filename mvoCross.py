...
mean_returns = data_merged[['Total_returns_asset1', 'Total_returns_asset2', 'Total_returns_asset3']].mean()
cov_matrix = data_merged[['Total_returns_asset1', 'Total_returns_asset2', 'Total_returns_asset3']].cov()
...
plt.bar(range(len(optimal_weights)), optimal_weights, tick_label=['Commodities', 'Naive ETFs', 'ETF over SPY'])
...
daily_returns = data_merged[['Total_returns_asset1', 'Total_returns_asset2', 'Total_returns_asset3']].dot(optimal_weights)
